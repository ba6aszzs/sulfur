    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0d0e0d]/90 backdrop-blur-lg border-b border-white/5">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="#delivery" className="text-[11px] font-bold tracking-[0.12em] uppercase text-white/40 transition-colors hover:text-[#F26500]">Delivery</a>
      ...
      <AnimatePresence>
        {open && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="overflow-hidden border-t bg-[#0d0e0d]" style={{ borderColor: "rgba(255,255,255,0.05)" }}>
            <div className="flex flex-col gap-1 px-4 py-4 sm:px-6">
              ...
              <a href="#delivery" onClick={() => setOpen(false)} className="flex min-h-11 items-center rounded px-4 text-[11px] font-bold tracking-[0.12em] uppercase text-white/40">Delivery</a>
