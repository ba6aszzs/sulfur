    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F3F4F6]/90 backdrop-blur-lg border-b border-black/5">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="#sobre" className="text-[11px] font-bold tracking-[0.12em] uppercase text-[#0d0e0d]/40 transition-colors hover:text-[#F26500]">Sobre</a>
          <a href="#diferenciais" className="text-[11px] font-bold tracking-[0.12em] uppercase text-[#0d0e0d]/40 transition-colors hover:text-[#F26500]">Diferenciais</a>
